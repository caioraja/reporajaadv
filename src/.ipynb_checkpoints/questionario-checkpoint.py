def questionario():
    ...
    def _perguntas_historia(arg0, arg1, arg2, arg3, arg4, arg5, arg6):
        marca = str(input(arg0))
        hist = str(input(arg1))
        proposito = str(input(arg2))
        servico = str(input(arg3))
        visao = str(input(arg4))
        missao = str(input(arg5))
        valores = str(input(arg6))
        return [marca, hist, proposito, servico, visao, missao, valores]

    def _perguntas_modelo(arg0, arg1, arg2, arg3, arg4, arg5, arg6):
        modelos = int(input(arg0))
        modelos_extenso = str(input(arg1))
        segmento = str(input(arg2))
        faturamento = str(input(arg3))
        unidades = str(input(arg4))
        homebased = str(input(arg5))
        sistemaop = str(input(arg6))
        return [modelos, modelos_extenso, segmento, faturamento, unidades, homebased, sistemaop]
    ...
    historia = _perguntas_historia(
        "Qual é o nome da marca do cliente? ",
        "Conte uma breve história da empresa: ",
        "Qual e o proposito da empresa: ",
        "Qual serviço é prestado pela marca? ",
        "Qual a visao da marca? ",
        "Qual é a missao da marca? ",
        "Qual sao os valores da marca? ",
    )
    ...
    modelo = _perguntas_modelo(
        "Quantos modelos de negocios a marca utiliza: (1 - Um / 2 - Mais de um) - ",
        "Digite o número por extenso: ",
        "Qual e o segmento da marca? ",
        "Qual a variação de faturamento do segmento?",
        "Qual a variação da quantidade de novas unidades do segmento?",
        "A franquia sera homebased? (1 - Sim; 0 - Nao) - ",
        "Qual e o sistema operacional da marca? ",
    )
